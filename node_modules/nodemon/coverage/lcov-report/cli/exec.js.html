...
<html lang="en">
<head>
    <title>Code coverage report for cli/exec.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cli/exec.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">cli/</a> &#187; exec.js</div>
</div>
<div class="body">
...
function exec(script, nodemonOptions, extentionMap) {
  <span class="missing-if-branch" title="else path not taken"" >E</span>if (!extentionMap) {
    extentionMap = {};
  }
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken"" >I</span>if (extentionMap[extention] !== undefined) {
<span class="cstat-no" title="statement not covered" >    options.exec = extentionMap[extention];</span>
  }
&nbsp;
  // note: indexOf('coffee') handles both .coffee and .litcoffee
    ...
    <span class="missing-if-branch" title="if path not taken"" >I</span>if (options.execArgs === undefined) <span class="cstat-no" title="statement not covered" >options.execArgs = [];</span>
&nbsp;
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (options.execArgs.indexOf('--nodejs') === -1) {
