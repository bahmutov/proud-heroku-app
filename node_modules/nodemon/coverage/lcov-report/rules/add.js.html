...
<html lang="en">
<head>
    <title>Code coverage report for rules/add.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">rules/add.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">rules/</a> &#187; add.js</div>
</div>
<div class="body">
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken"" >I</span>if (Array.isArray(rule)) {
<span class="cstat-no" title="statement not covered" >    rule.forEach(<span class="fstat-no" title="function not covered" >function (rule) {</span></span>
<span class="cstat-no" title="statement not covered" >      add(rules, which, rule);</span>
    });
...
<span class="cstat-no" title="statement not covered" >    rule = ':' + rule.toString().replace(/^\/(.*?)\/$/g, '$1');</span>
  }
&nbsp;
