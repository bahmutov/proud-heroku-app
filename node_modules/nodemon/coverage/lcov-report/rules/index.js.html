...
<html lang="en">
<head>
    <title>Code coverage report for rules/index.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">rules/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">rules/</a> &#187; index.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function test(which, filename) {</span>
...
<span class="cstat-no" title="statement not covered" >    var fileParts = filename.split(/\\/g);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    filename = '/' + fileParts.join('/');</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  return which ? result[which] : result;</span>
}
&nbsp;
&nbsp;
/**
